...
export const project1 = [
  {
    ...
    features: "▷ 주요 특징 및 기능",
    feat1:
      "Framer Motion을 활용해 텍스트, 이미지, 링크 등이 자연스럽게 등장하도록 애니메이션 효과를 적용하여 역동적인 사용자 경험을 제공하였습니다.",
    feat2:
      "단순한 이력 소개가 아닌 인터뷰 형식을 차용해, 보다 생동감 있게 나에 대한 부분을 소개하도록 하였습니다.",
    feat3:
      "Figma를 활용해 디자인을 기획하고, 체계적으로 UI/UX를 구성하였습니다.",
    feat4:
