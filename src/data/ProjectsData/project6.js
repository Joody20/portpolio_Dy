...
export const project6 = [
  {
    ...
    description:
      "어떤 병원에서 검진용 모바일 어플리케이션을 운영하고 있다. 이 앱에서는 환자들의 운동 수행 정보를 서버로 보내어 저장합니다. 이 정보 데이터들을 활용하여 서버의 API 정보를 토대로 운동 기록을 시각화하는 서비스를 개발했습니다. 파킨슨 병은 세계 2위 퇴행성 노인 질환이며 국내 환자 수 2004년 대비 3.2배 증가하였고 최근 5년간 15%이상 증가했다고 합니다. 목소리 발성(지속 발성, 반복 발성) , 눈검사(화면주시, 빠른 깜빡임), 손가락 검사, 걸음 검사로 선정된 운동 데이터를 통해 의료진 대시보드를 구현하였습니다.",
    close: close_btn,
    git: git,
