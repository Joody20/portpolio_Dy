...
export const project2 = [
  {
    ...
    user_feat7:
      "DB에 저장되어 있는 학생들만 물품대여를 가능하게끔 권한을 설정해놓았습니다. 졸업생 및 타과학생들은 물품대여를 할 수 없도록 관리했습니다.",
    user: user,
    admin_feat: " 관리자(학생회)모드",
    admin_feat1:
      "회원가입 신청 : 학생회 부원이 회원가입을 요청하면, 회장에게 승인요청이 전달.",
    admin_feat2:
      "회장승인 : 학생회 회장이 신청을 검토하고 승인을 해야만 로그인 가능.",
    admin_feat3: "로그인 : 승인된 학생회 부원만이 관리자 모드에 로그인 가능.",
    admin_feat4:
      "회장전용 접근 설정 : 회장은 모든 도메인에 접근 가능하며, 특정 도메인에 대해 각 학생회 부원들의 접근 권한을 설정 가능.",
    admin_feat5:
      "일반 학생회원 접근 제한 : 회장이 설정한 권한에 따라 일반 학생회 부원은 승인된 도메인에만 접근 가능.",
    admin: admin,
    window: "주요 화면",
    photo1: unic1,
    photo2: unic2,
